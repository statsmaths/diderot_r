...
##############################################################################
# 28. This means you can retrieve ranges of values. Get the second through
# fourth words:
...
# plotting package we need is loaded by calling this function:

library(tidyverse)

# If you get an error, make sure you have run "setup.R" on your machine first!
...
##############################################################################
# 43. You can also take two vectors and compare each item. See which values
...
##############################################################################
# 47. Now try getting the square roots with sqrt:
...
##############################################################################
# 49. Now, try creating a second vector with the sines of those values:
